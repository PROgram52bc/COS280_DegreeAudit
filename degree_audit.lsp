(defun requirement-fulfilled (course-name person)
  ; return non-nil if fulfilled, nil if not fulfilled
...
(defparameter person '(
  (transcript (COS102 A-) (COS109 A) (COS120 B) (COS121 B+) (COS143 A-) (COS243 B+) (COS265 B) (COS284 B-) (MAT151 A-) (MAT210 B) (HUM230 D-))
